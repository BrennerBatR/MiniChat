...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@172.16.103.195';
     ...
     * Returns '172.16.103.195.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return '172.16.103.195.localdomain';
        }
